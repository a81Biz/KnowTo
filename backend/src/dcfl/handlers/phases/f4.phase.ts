...
const productHandlers: Record<string, Record<string, Function>> = {
  ...
  'ensamblador_doc_generic': {
    'F4_P2_GENERATE_DOCUMENT': handleDocumentGenericAssembler,
    'F4_P3_GENERATE_DOCUMENT': handleDocumentGenericAssembler,
    'F4_P4_GENERATE_DOCUMENT': handleDocumentGenericAssembler,
    'F4_P5_GENERATE_DOCUMENT': handleDocumentGenericAssembler,
    'F4_P6_GENERATE_DOCUMENT': handleDocumentGenericAssembler,
    'F4_P7_GENERATE_DOCUMENT': handleDocumentGenericAssembler,
    'F4_P8_GENERATE_DOCUMENT': handleDocumentGenericAssembler,
  },
  ...
  'ensamblador_form_schema': { 'F4_GENERATE_FORM_SCHEMA': handleFormSchemaAssembler },
};
...
export async function handleF4Events(event: PipelineEvent): Promise<string | void> {
  ...
  // Assembler de form schema: maneja cualquier pipeline F4_P*_FORM_SCHEMA o F4_GENERATE_FORM_SCHEMA
