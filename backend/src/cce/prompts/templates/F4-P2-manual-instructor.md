...
pipeline_steps:
  - agent: specialist
    task: "Actúa como Diseñador Instruccional EC0301. Usando el {{context}} (Estructura temática, Perfil de Ingreso, Pedagogía), redacta la Carta Descriptiva completa del curso prioritario."
  - agent: judge
    rules: 
