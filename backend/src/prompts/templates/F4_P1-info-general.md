...
## INSTRUCCIÓN
Genera SOLO el DOCUMENTO DE INFORMACIÓN GENERAL (Producto 1 / E1219 - producto #2). No generes ningún otro producto.

Extrae del contexto: título del curso (F1/F2), objetivos (F1), perfil de ingreso (F2), perfil de egreso (F1), duración (F3), plataforma LMS (F3), arquitectura de evaluación (F3).
...
- **Cognitivo:** [verbo Bloom] [qué] a través de [medio instruccional]
- **Psicomotor:** [verbo] [qué] a través de [medio instruccional]
- **Afectivo:** [verbo] [qué] a través de [medio instruccional]

## 1.4 Perfil de ingreso
[Del análisis en F2 — escolaridad mínima, conocimientos previos, habilidades digitales, equipo requerido, conectividad]

## 1.5 Perfil de egreso
Al terminar el curso, el participante será capaz de:
1. [Competencia 1 — del contexto F1]
2. [Competencia 2]
3. [Competencia 3]
...
[Descripción de cómo está organizado el curso: progresión de módulos, cómo acceder a actividades, iconografía de navegación. Adaptar al LMS indicado en F3.]

## 1.8 Metodología de trabajo
**A. Cómo se va a enseñar:** [técnicas instruccionales según nivel de interactividad de F2]
**B. Cómo se trabaja con el participante:** [rol del instructor/tutor según modalidad de F2]
...
|:---|:---|:---|
| Diagnóstica | 0% | [del contexto F3 arquitectura de evaluación] |
| Formativa | [%] | [del contexto F3] |
| Sumativa | [%] | [del contexto F3] |
| Calificación mínima aprobatoria | [%] | [del contexto F3] |

## 1.11 Duración del curso
[Del contexto F3 — horas totales, semanas, distribución semanal. Incluir tabla de distribución si aplica.]

## INSTRUCCIONES DE CALIDAD
- Usa verbos de la taxonomía de Bloom en todos los objetivos.
- Todo debe estar basado en el contexto acumulado — no inventes datos.
