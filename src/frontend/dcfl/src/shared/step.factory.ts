// src/shared/step.factory.ts
// Factory para crear controladores de paso del wizard.
// Elimina el boilerplate de subclase + instancia repetido en cada controller.
// FRONTEND ARCHITECTURE DOCUMENT — sección 5 (API Pública)
