      ...
      try {
        ...
        if (res.data?.projectId) {
          ...
          wizardStore.setClientData({
            ...
            deadline: formData['deadline'] as string ?? '',
            constraints: formData['constraints'] as string ?? '',
            nombreOficialCurso: formData['nombreOficialCurso'] as string ?? '',
            dominioTecnico: formData['dominioTecnico'] as string ?? '',
            resultadoCentral: formData['resultadoCentral'] as string ?? '',
            audienciaPrimaria: formData['audienciaPrimaria'] as string ?? '',
            estandarNorma: formData['estandarNorma'] as string ?? '',
          });
          state = wizardStore.getState();
