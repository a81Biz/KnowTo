...
export interface ClientData {
  ...
  deadline?: string;
  constraints?: string;
  // Anclas Semánticas (fuente de verdad inmutable para pipelines IA)
  nombreOficialCurso?: string;
  dominioTecnico?: string;
  resultadoCentral?: string;
  audienciaPrimaria?: string;
  estandarNorma?: string;
}
...
export interface WizardState {
  ...
  formCache: Record<string, unknown>;
