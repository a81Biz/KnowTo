...
import F4_P4_CHAPTER from './templates/F4_P4_CHAPTER.md';
...
import TEMARIO_BASE from './templates/TEMARIO_BASE.md';
...
// PT-085: Version map — format 'YYYY-MM-DD' (last significant edit date per template).
// Used by saveArtifactVersion and saveAgentOutput to compute prompt_hash.
export const DCFL_PROMPT_VERSIONS: Partial<Record<PromptId, string>> = {
  F0:                    '2025-04-15',
  F1:                    '2025-04-15',
  F2:                    '2025-04-15',
  F2_5:                  '2025-04-15',
  F3:                    '2025-04-15',
  F4_P1_FORM_SCHEMA:     '2025-05-01',
  F4_P1_GENERATE_DOCUMENT: '2026-06-12',
  F4_P2_FORM_SCHEMA:     '2025-05-01',
  F4_P2_GENERATE_DOCUMENT: '2026-06-12',
  F4_P3_FORM_SCHEMA:     '2025-05-01',
  F4_P3_GENERATE_DOCUMENT: '2026-06-12',
  F4_P3_ORCHESTRATOR:    '2025-06-01',
  F4_P4_FORM_SCHEMA:     '2025-05-01',
  F4_P4_GENERATE_DOCUMENT: '2026-06-12',
  F4_P4_CHAPTER:         '2025-06-01',
  F4_P5_FORM_SCHEMA:     '2025-05-01',
  F4_P5_GENERATE_DOCUMENT: '2026-06-12',
  F4_P6_FORM_SCHEMA:     '2025-05-01',
  F4_P6_GENERATE_DOCUMENT: '2026-06-12',
  F4_P7_FORM_SCHEMA:     '2025-05-01',
  F4_P7_GENERATE_DOCUMENT: '2026-06-12',
  F4_P8_FORM_SCHEMA:     '2025-05-01',
  F4_P8_GENERATE_DOCUMENT: '2026-06-12',
  F5:                    '2025-04-15',
  F5_2:                  '2025-04-15',
  F6:                    '2025-04-15',
  F6_FORM:               '2025-04-15',
  ...
  F6_2b:                 '2025-04-15',
  F7:                    '2025-04-15',
  TEMARIO_BASE:          '2025-04-15',
  EXTRACTOR:             '2025-04-15',
};
