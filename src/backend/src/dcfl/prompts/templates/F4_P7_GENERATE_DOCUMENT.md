...
pipeline_steps:
  ...
  - agent: agente_descripcion_A
    ...
    task: |
      ...
      GLOBAL CONSTRAINT: NEVER leave unresolved placeholders ({{variable}}, [PENDIENTE], [INSERTAR], TBD). The certification standard (if any) is in _frozen.estandar_norma — NOT the course name or topic.
  ...
  - agent: agente_conceptos_A
    ...
    task: |
      ...
      CORRECT:   "normativa": ["NOM-026-STPS-2008", "EC0366 CONOCER"] (or the applicable standard from _frozen.estandar_norma)
