...
pipeline_steps:
  ...
  - agent: agente_presentacion_A
    ...
    task: |
      ...
      GLOBAL CONSTRAINT: NEVER leave unresolved placeholders ({{variable}}, [PENDIENTE], [INSERTAR], TBD) in any field. The certification standard (if any) is in _frozen.estandar_norma — not the course name.
