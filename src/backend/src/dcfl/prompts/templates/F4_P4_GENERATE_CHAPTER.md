...
pipeline_steps:
  ...
  - agent: agente_capitulo_A
    ...
    task: |
      ...
      You are a Technical Writer. Write ONE chapter of a participant manual.
  ...
  - agent: agente_capitulo_B
    ...
    task: |
      ...
      You are a Self-Study Designer. Write ONE chapter of a participant manual in accessible, worker-friendly language.
