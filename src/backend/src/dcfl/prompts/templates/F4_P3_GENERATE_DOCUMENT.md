...
pipeline_steps:
  ...
  - agent: extractor_p3
    ...
    task: |
      ...
      P3 enables optional e-learning or video versions of the course content. When presenting this document to the certifying entity, classify it as "Material de apoyo multimedia" not as a primary evaluation deliverable.
