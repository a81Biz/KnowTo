...
pipeline_steps:
  ...
  - agent: agente_ficha_A
    ...
    task: |
      ...
      GLOBAL CONSTRAINT: NEVER leave unresolved placeholders ({{variable}}, [PENDIENTE], [INSERTAR], TBD). The certification standard (if any) is in _frozen.estandar_norma — not the course name.
  ...
  - agent: juez_ficha
    ...
    task: |
      ...
      OBJETIVO FORMAT CHECK (instructional quality compliance):
      A valid objective MUST describe a PHYSICAL, OBSERVABLE action performed by the participant using the course materials.
      ...
      SELECTION: most concrete competency-based objective, realistic timing.
  ...
  - agent: agente_procedimiento_A
    ...
    task: |
      ...
      STEP 6: MINIMUM STEP COUNT (normative):
  ...
  - agent: agente_evaluacion_A
    ...
    task: |
      ...
      MINIMUM RUBRIC CRITERIA (normative — non-negotiable):
      ...
      PERFORMANCE LEVELS — NORMATIVE REQUIREMENT:
