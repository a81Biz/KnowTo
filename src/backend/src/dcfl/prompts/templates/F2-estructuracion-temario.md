...
pipeline_steps:
  ...
  - agent: extractor_f2
    ...
    task: |
      ...
      - Project context:
        ...
        - F1: {{previousData.f1_estructurado}}
  ...
  - agent: especialista_temario_a
    ...
    include_template: false
    task: |
      You are an Instructional Designer for competency-based instructional design "Online Course Development".
      ...
      YOUR TASK: Design a complete course structure aligned to instructional design standards and the certification standard in _frozen.estandar_norma (if present in context).
      ...
      Design exactly one module per approved learning objective (usually 3 modules). Each module requires: nombre, objetivo, duracion_estimada_horas.
      
      OBJECTIVE WRITING RULES (instructional design guidelines §4.2):
      ...
      ### STEP 4: Define ENTRY PROFILE (perfil_ingreso)
  ...
  - agent: especialista_temario_b
    ...
    include_template: false
    task: |
      You are an Instructional Designer for competency-based instructional design — CREATIVE AND ALTERNATIVE perspective.
