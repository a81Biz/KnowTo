...
pipeline_steps:
  ...
  - agent: agente_analisis_A
    ...
    task: |
      You are a Needs Analysis Specialist in instructional design.
  ...
  - agent: agente_analisis_B
    ...
    include_template: false
    task: |
      You are a Needs Analysis Specialist in instructional design — SKEPTICAL perspective.
  ...
  - agent: agente_estrategia_A
    ...
    include_template: false
    task: |
      You are an Instructional Strategy Specialist experienced in competency-based course design.
  ...
  - agent: agente_estrategia_B
    ...
    include_template: false
    task: |
      You are an Instructional Strategy Specialist experienced in competency-based course design — MEASURABILITY focus.
