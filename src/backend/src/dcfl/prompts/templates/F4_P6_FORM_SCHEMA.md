...
pipeline_steps:
  ...
  - agent: agente_form_A
    ...
    task: |
      ...
      You are a Course Scheduler for competency-based instructional design. Your task is to plan the session schedule for a course.
      ...
      This is required to establish the participant's baseline before instruction begins.
  ...
  - agent: agente_form_B
    ...
    task: |
      ...
      You are a Course Logistics Planner for competency-based instructional design. Your task is to create descriptive session charts.
      ...
      MANDATORY THIRD ITEM — EVALUACIÓN DIAGNÓSTICA:
      The THIRD element MUST always be the diagnostic session (Sesión 0) required by the applicable standard.
