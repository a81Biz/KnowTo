...
pipeline_steps:
  ...
  - agent: agente_form_A
    ...
    task: |
      ...
      You are a Technical Writer for competency-based instructional design. Your task is to scaffold participant manual chapters with all 7 required sections.
  ...
  - agent: agente_form_B
    ...
    task: |
      ...
      You are a Competency-Based Instructional Designer for competency-based instructional design. Your task is to scaffold participant manual chapters with all 7 required sections, focused on demonstrable skills.
