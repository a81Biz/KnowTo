...
pipeline_steps:
  ...
  - agent: agente_form_A
    ...
    task: |
      ...
      You are a Production Planner scheduling the development of all course materials.
  ...
  - agent: agente_form_B
    ...
    task: |
      ...
      You are a Resource Manager planning production resources and validation milestones.
