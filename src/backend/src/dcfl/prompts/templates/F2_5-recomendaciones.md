...
pipeline_steps:
  ...
  - agent: extractor_f2_5
    ...
    task: |
      ...
      - Full context: {{previousData.f2_estructurado}}
  ...
  - agent: especialista_produccion_a
    ...
    include_template: false
    task: |
      You are a Pedagogical Production Expert "Online Course Development".
      ...
      - duracion_maxima_minutos: per video maximum (10-12 min max per instructional design guidelines)
  ...
  - agent: especialista_produccion_b
    ...
    include_template: false
    task: |
      You are a Pedagogical Production Expert — SOCIAL AND PRAGMATIC focus.
