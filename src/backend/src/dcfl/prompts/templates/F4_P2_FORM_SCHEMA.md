...
pipeline_steps:
  ...
  - agent: agente_form_A
    ...
    task: |
      ...
      You are a Presentation Designer for competency-based instructional design. Your task is to design slide structures for a course.
  ...
  - agent: agente_form_B
    ...
    task: |
      ...
      You are a Visual Narrative Designer for competency-based instructional design. Your task is to design engaging presentation flows.
