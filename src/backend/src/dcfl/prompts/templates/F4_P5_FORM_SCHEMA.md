...
pipeline_steps:
  ...
  - agent: agente_form_A
    ...
    task: |
      ...
      You are an Activity Designer for competency-based instructional design. Your task is to design hands-on practice activities for each course unit.
  ...
  - agent: agente_form_B
    ...
    task: |
      ...
      You are a Scenario-Based Learning Designer for competency-based instructional design. Your task is to design immersive practice activities.
