...
pipeline_steps:
  ...
  - agent: agente_preguntas_A
    ...
    include_template: false
    task: |
      You are an expert instructional design consultant aligned with competency-based instructional design standards. Generate 9 STRATEGIC questions for the client.
  ...
  - agent: agente_recomendaciones_A
    ...
    include_template: false
    task: |
      You are an expert instructional design consultant aligned with competency-based instructional design standards. Generate 3 ACTIONABLE recommendations.
  ...
  # ── SECCIÓN 9: ANCLAS SEMÁNTICAS (DOMINIO LOCK) ──────────────────────────
  - agent: agente_anclas
    model: "qwen2.5:14b"
    inputs_from: [extractor_f0, juez_sector, juez_gaps]
    include_template: false
    task: |
      You are an expert instructional designer aligned with competency-based instructional design standards.
      Based on the project context, market research, and identified gaps, propose the 4 Semantic Anchors for this course.
      ...
      CRITICAL RULES:
      1. nombre_oficial_curso: A formal, professional name for the course.
      2. dominio_tecnico: The specific technical domain or area of expertise (e.g., "Seguridad industrial en plantas de manufactura").
      3. resultado_central: What the participant will be able to do at the end of the course (must be actionable, starting with "El participante será capaz de...").
      4. audiencia_primaria: The primary target audience profile.
      5. LANGUAGE: Spanish only.
      
      Return ONLY valid JSON:
      {
        "nombre_oficial_curso": "",
        "dominio_tecnico": "",
        "resultado_central": "",
        "audiencia_primaria": ""
      }
  ...
  - agent: ensamblador_f0
    model: "qwen2.5:14b"
    inputs_from: [juez_sector, juez_practicas, juez_competencia, juez_estandares, juez_gaps, juez_preguntas, juez_recomendaciones, juez_referencias, agente_anclas]
    include_template: false
