...
export async function generateStrategicQuestions(
  ...
  const prompt = `
You are an instructional design consultant expert in competency-based course design. You are advising an expert who wants to create and sell an online course.
